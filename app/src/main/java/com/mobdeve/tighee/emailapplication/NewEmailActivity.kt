    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.sendBtn.setOnClickListener(View.OnClickListener {
            if (viewBinding.toEt.text.toString().isNotEmpty() && viewBinding.subjectEt.text.toString().isNotEmpty() && viewBinding.bodyEt.text.toString().isNotEmpty()) {
                 ...
                 * */
//                val intent = intent
                intent.putExtra(NEW_RECEIVER_KEY, viewBinding.toEt.text.toString())
                intent.putExtra(NEW_SUBJECT_KEY, viewBinding.subjectEt.text.toString())
                intent.putExtra(NEW_BODY_KEY, viewBinding.bodyEt.text.toString())
